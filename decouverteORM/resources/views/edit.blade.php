                ...
                <form action="{{ route('mangas.update', $manga->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control @error('nomDessinateur') is-invalid @enderror" 
                            name="nomDessinateur" id="nomDessinateur" value="{{ old('nomDessinateur', $manga->nomDessinateur) }}"
                    ...
                    <div class="form-group">
                        ...
                        name="nomScenariste" id="nomScenariste" value="{{ old('nomScenariste', $manga->nomScenariste) }}" 
                        placeholder="Nom du scenariste">
                        @error('nomScenariste')
                            <div class="alert alert-danger">{{ $message }} </div>
                        @enderror 
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        name="genre" id="genre" value="{{ old('genre', $manga->genre) }}" 
                        placeholder="Genre du Manga">
                        @error('genre')
                            <div class="alert alert-danger">{{ $message }} </div>
                        @enderror 
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        name="prix" id="prix" value="{{ old('prix', $manga->prix) }}" 
                    ...
                    <div class="form-group">
                        ...
                        name="titre" id="titre" value="{{ old('titre', $manga->titre) }}" 
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="couverture"
                            id="couverture" value="{{ old('couverture', $manga->couverture) }}" 
